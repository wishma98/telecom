<x-app-layout>
    ...
    <body>
        <div class="container">
            <form action="{{ route('connectionType_news')}}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <label>Select End A on the Map (Central Province Only):</label>
                <div id="map"></div>
